 ...
 * @modifytime:
 */
public class SimpleHistogramSearcher {
     ...
     * @return
     */
    public static List<SimpleHistogramResponse> simpleSearch(TransportClient client , SimpleHistogram histogram) {
        ...
        List<SimpleHistogramResponse> simpleHistogramResponses = simpleSearchPager(client,histogram,null);
        return simpleHistogramResponses;
    }


    public static List<SimpleHistogramResponse> simpleSearchPager(TransportClient client , SimpleHistogram histogram , BoolPager pager) {
        HistogramAggregationBuilder builder = null;
        if(histogram.getTwoField() != null){
            AggregationBuilder metrics = buildMetrics(histogram);
            builder = AggregationBuilders.histogram(histogram.getField())
                    .field(histogram.getField())
                    .interval(histogram.getInterval())
